...
export default function Home() {
  return (
    <section
      id="home"
      className="relative flex min-h-screen flex-col items-center justify-center gap-6 px-8 text-center"
    >
      ...
      <div className="absolute bottom-8 flex items-center gap-5">
        <a
          ...
          aria-label="GitHub"
          className="text-neutral-500 transition-transform duration-200 hover:scale-125 dark:text-neutral-400"
        >
        ...
        <a
          href="https://linkedin.com/in/javkhlan-tso"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="LinkedIn"
          className="text-neutral-500 transition-transform duration-200 hover:scale-125 dark:text-neutral-400"
